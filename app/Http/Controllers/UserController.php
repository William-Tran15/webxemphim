...
class UserController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $wallet->delete();
        $user->delete();
        return redirect()->route('admin.user.list')->with(['thongbao_level' => 'success', 'thongbao' => "<b>Xoá người dùng thành công</b>"]);
    }
    ...
    public function loginuser(Request $request)
    {
        ...
        if (Auth::attempt($arr, true)) {
            ...
            return redirect()->back()->with(['thongbao_level' => 'success', 'thongbao' => "<b>Đăng nhập thành công!</b><br>Hãy tận hưởng những phút giây thư giản trên Movies </b>"]);
        } else
