...
class WalletController extends Controller
{
    public function getWallet()
    {
        ...
        $wallet=Wallet::all();
        $walletCharge=WalletCharge::paginate(5);
    ...
    public function postChargeWallet(Request $request)
    {
        ...
        $vnp_TmnCode = "SGURO3VL"; //Mã website tại VNPAY
        $vnp_HashSecret = "JHYCQLGZMFJZEDNSBQGVMRCUFIZCARKO"; //Chuỗi bí mật
    ...
    public function saveChargeWallet($username)
    {
        ...
        */
        ...
        $secureHash = hash('sha512', $vnp_HashSecret . $hashData);
        $Status = 0;
