...
class MovieController extends Controller
{
    ...
    public function watchmovie($id, $server)
    {
        ...
        $pythonScriptPath = '../../app/recommender.py';
        $realUrl = realpath($pythonScriptPath);
        $movie_all = Movie::latest()->limit(3)->get();
        $escapedData = escapeshellarg($movie_all);
        $sliderCate = shell_exec("python $realUrl $escapedData 2>&1");
