<?php $__env->startSection('title','Hồ Sơ Của Tôi - MinMovies'); ?>
                ...
                <div class="modal-body">
                    <div class="w3_login_module">
                        <div class="module form-module">
                            ...
                            <div class="form">
                                <h3>Thông Tin</h3>
                                <form action="<?php echo e(route('user.postProfile')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <input type="text" name="name" value="<?php echo e($user->name); ?>" placeholder="Tên người dùng" required="" oninvalid="this.setCustomValidity('Có phải bạn có quên mất gì đó?')"
                                    oninput="this.setCustomValidity('')">
                                    <input type="text" readonly placeholder="Tài khoản: <?php echo e($user->username); ?>">
                                    <input type="email" readonly placeholder="Email: <?php echo e($user->email); ?>">
                            ...
                            <div class="form">
                                <h3>Đổi Mật Khẩu</h3>
                                <form name="form1" action="<?php echo e(route('user.postProfile')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webxemphim\resources\views/user/profile.blade.php ENDPATH**/ ?>