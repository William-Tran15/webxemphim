<?php $__env->startSection('title','Sửa Phim - Movie'); ?>
...
<div class="container-fluid border-danger">
    <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('admin.movie.edit',$movie->id)); ?>">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-3 pb-3">
                <img class="img-thumbnail" src="<?php echo e('storage/app/poster/'.$movie->poster_image); ?>" alt="" title="<?php echo e(asset('storage/app/poster/'.$movie->poster_image)); ?>">
                </div>
                <div class="col-md-9">
                    <div class="pb-3">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" class="uploadimg"
                                for="inputGroupFile01"><?php echo e('storage/app/poster/'.$movie->poster_image); ?></label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="input-group pb-3">
                ...
                <input type="number" class="form-control" name="txtPrice" title="Giá phim" value="<?php echo e($movie->price); ?>" maxlength="8">
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group pb-3">
            ...
            <textarea class="ckeditor" style="resize:none;" name="txtInfo" id="editor" cols="30"
                rows="10"><?php echo e($movie->information); ?></textarea>
            <script>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\webxemphim\resources\views/admin/movie/edit.blade.php ENDPATH**/ ?>