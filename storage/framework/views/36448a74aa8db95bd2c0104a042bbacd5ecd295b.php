<?php $__env->startSection('title','Phim '.$catename->cate_name.' - MinMovies'); ?>
            ...
            <div class="browse-agile-w3ls general-w3ls">
                <div class="tittle-head">
                    <h4 class="latest-text">
                        Phim <?php echo e($catename->cate_name); ?>
                    ...
                    <div class="container">
                        <div class="agileits-single-top">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><?php echo e($catename->cate_name); ?></li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webxemphim2\resources\views/user/cate.blade.php ENDPATH**/ ?>