    ...
    <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('admin.movie.create')); ?>">
        ...
        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-3 pb-3">
                    <select class="wide" name="nation_id" required="">
                        <option data-display="Quốc gia" value="0">Chưa chọn...</option>
                ...
                <div class="col-md-3 pb-3">
                    <select class="wide" name="year_id" required="">
                        <option data-display="Năm sản xuất" value="0">Chưa chọn...</option>
                ...
                <div class="col-md-3 pb-3">
                    <select class="wide" name="language_id" required="">
                        <option data-display="Ngôn ngữ" value="0">Chưa chọn...</option>
            ...
            <textarea class="ckeditor" style="resize:none;" name="txtInfo" id="editor" cols="30" rows="10"></textarea>
            <script>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webxemphim\resources\views/admin/movie/add-movie.blade.php ENDPATH**/ ?>