    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span class="mr-2 d-none d-lg-inline text-gray-600 small" title="Hồ sơ"><?php echo e(Auth::user()->name); ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?php echo e(route('admin.user.edit',Auth::user()->id)); ?>">
...
<?php /**PATH C:\xampp\htdocs\webxemphim2\resources\views/admin/admin_layout/topbar.blade.php ENDPATH**/ ?>