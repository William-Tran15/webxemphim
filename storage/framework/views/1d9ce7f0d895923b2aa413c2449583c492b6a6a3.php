<?php $__env->startSection('title','Danh Sách Bình Luận - MinMovie'); ?>
...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800 text-center">QUẢN LÝ BÌNH LUẬN</h1>
        <!-- DataTales Example -->
                    ...
                    <table class="table table-bordered table-hover table-striped text-center" id="dataTable"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href=" <?php echo e(route('admin.comment.del',$item->id)); ?> " data-toggle="confirm"
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webxemphim\resources\views/admin/comment/list.blade.php ENDPATH**/ ?>