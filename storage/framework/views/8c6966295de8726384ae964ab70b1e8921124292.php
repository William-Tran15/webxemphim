<?php $__env->startSection('title','Danh Sách Phim - Movie'); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped text-center" id="dataTable"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo e($i++); ?></td>
                                <td><a class="text-decoration-none" href="<?php echo e(route('user.movie',$item->id)); ?>" title="Mở trong tab mới" target="_blank"><b><?php echo e($item->vie_name); ?></b></a></td>
                                <td><a class="text-decoration-none" href="<?php echo e(route('user.movie',$item->id)); ?>" title="Mở trong tab mới" target="_blank"><b><?php echo e($item->eng_name); ?></b></a></td>
                                <td>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\webxemphim\resources\views/admin/movie/list.blade.php ENDPATH**/ ?>