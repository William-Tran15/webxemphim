    ...
    <div class="col-md-12">
        <div class="content-based-recommendation">
            ...
            <div class="movie-list row">
                <?php $count = 0; ?>
                <?php $__currentLoopData = $similarMovies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $similarMovie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($count % 4 == 0): ?>
                        </div><div class="row">
                    <?php endif; ?>
                    <div class="col-md-3">
                        <div class="movie-item">
                            <a href="<?php echo e(route('user.movie', $similarMovie['id'])); ?>" title="<?php echo e($similarMovie['vie_name'] . (isset($similarMovie['eng_name']) ? ' (' . $similarMovie['eng_name'] . ')' : '')); ?>" class="hvr-shutter-out-horizontal">
                                <img src="<?php echo e('storage/app/poster/' . $similarMovie['poster_image']); ?>" title="<?php echo e($similarMovie['vie_name'] . (isset($similarMovie['eng_name']) ? ' (' . $similarMovie['eng_name'] . ')' : '')); ?>" class="img-responsive" alt=" " />
                                <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
                            </a>
                            <div class="movie-details mt-2">
                                <div class="w3l-movie-text">
                                    <a href="<?php echo e(route('user.movie', $similarMovie['id'])); ?>" title="<?php echo e($similarMovie['vie_name']); ?>"><?php echo e($similarMovie['vie_name']); ?></a>
                                </div>
                                <p>
                                    <?php $__currentLoopData = $year; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($item->id == $similarMovie['year_id']): ?>
                                ...
                                <div class="block-stars">
                                    <ul class="w3l-ratings">
                                        <p><?php echo e($similarMovie['time']); ?></p>
                                    </ul>
                                </div>
                                <div class="ribben">
                                    <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($similarMovie['language_id'] == $lang->id): ?>
                                            <a href="<?php echo e(route('user.movie', $similarMovie['id'])); ?>" title="<?php echo e($similarMovie['vie_name'] . (isset($similarMovie['eng_name']) ? ' (' . $similarMovie['eng_name'] . ')' : '')); ?>">
                                                <p><?php echo e($similarMovie['quality'] . '-' . $lang->language); ?></p>
                                            </a>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <div class="ribbennew5">
                                    <span class="badge badge-pill badge-danger price2 text-center" style="margin-top:5px;">
                                        <?php if($similarMovie['price'] == 0): ?>
                                            Miễn phí
                                        <?php else: ?>
                                            <?php echo e(number_format(round($similarMovie['price'])) . 'đ'); ?>
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\webxemphim\resources\views/user/detailmovie.blade.php ENDPATH**/ ?>