<?php $__env->startSection('title','Giới Thiệu Về Chúng Tôi - MinMovies'); ?>
...
<div class="faq">
    ...
    <div class="container">
        <h4 class="pt-1"><b>Quản trị viên: </b>Từ Thiện Bảo Minh</h4>
        <h4 class="pt-1"><b>Số điện thoại: </b>0966******</h4>
        <h4><b>Email: </b>vcb******@gmail.com</h4>
        <h4><b>Địa chỉ: </b>***, Việt Nam</h4>

    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webxemphim\resources\views/user/about.blade.php ENDPATH**/ ?>