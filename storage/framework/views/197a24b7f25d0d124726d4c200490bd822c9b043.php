<?php $__env->startSection('title','Phim Năm '.$yearname->year.' - MinMovies'); ?>
            ...
            <div class="browse-agile-w3ls general-w3ls">
                <div class="tittle-head">
                    <h4 class="latest-text">
                        Phim Năm <?php echo e($yearname->year); ?>
                    ...
                    <div class="container">
                        <div class="agileits-single-top">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Năm <?php echo e($yearname->year); ?></li>
                            </ol>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webxemphim2\resources\views/user/year.blade.php ENDPATH**/ ?>