<?php $__env->startSection('title','Khôi Phục Mật Khẩu - MinMovies'); ?>
    ...
    <div class="container">
        <div class="agileits-single-top">
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(route('user.index')); ?>">Đăng Nhập</a></li>
                <li><a href="<?php echo e(route('user.getrecoverpassword')); ?>">Khôi Phục Mật Khẩu</a></li>
                        ...
                        <div class="module form-module">
                            ...
                            <div class="form">
                                ...
                                <form action="" method="post" name="form1">
                                    <?php echo csrf_field(); ?>
                                    <input type="text" maxlength="50" placeholder="Email" disabled value="<?php echo e($data['username']); ?>">
                                    <input type="email" name="email" maxlength="50" placeholder="Email" disabled value="<?php echo e($data['email']); ?>">
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webxemphim2\resources\views/user/recoverNewPassword.blade.php ENDPATH**/ ?>