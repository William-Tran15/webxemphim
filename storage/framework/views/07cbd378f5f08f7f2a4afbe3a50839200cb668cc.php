            ...
            <div class="col-md-4">
                <div class="moviedetailinfor">
                    ...
                    <div class="moviedetailinfor2">
                        ...
                        <?php if($item->id==$movie->nation_id): ?>
                        <p><b>Quốc gia: </b><a
                                href="<?php echo e(route('user.nation',$movie->nation_id)); ?>"><?php echo e($item->nation_name); ?></a></p>
                        <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $year; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($item->id==$movie->year_id): ?>
                                            ...
                                            <div class="w3_login_module">
                                                <div class="module form-module">
                                                    <div class="toggle"><a class="walletI"
                                                            href="<?php echo e(route('user.getChargeWallet')); ?>">
                                                    ...
                                                    <div class="form">
                                                        <form action="<?php echo e(route('user.buyMovie',$movie->id)); ?>"
                                                            method="get">
                                                            <?php echo csrf_field(); ?>
                                                            ...
                                                            <h3>Bạn có muốn mua phim <b><?php echo e($movie->vie_name); ?></b> với
                                                                giá
                                                                <span
                                                                    class="badge badge-pill badge-danger price text-center"><?php echo e(number_format(round($movie->price)).'đ'); ?></span>
                                                            </h3>
                                                            <br>
                                                ...
                                                <li class="media">
                                                    <div class="media-body">
                                                        ...
                                                        <a href="<?php echo e(route('user.delComment',$item->id)); ?>"
                                                            class="btn btn-danger" data-toggle="confirm" role="button">Xoá</a>
                                                        <br><br>
...
<?php echo $__env->make('user.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webxemphim\resources\views/user/detailmovie.blade.php ENDPATH**/ ?>